...
namespace florid
{
    ...
    PackedCommandView ArmCore::pack_impl(const Torques& cmd)
    {
        ...
        copy_float(cmd.kp,               m_tx_joint_command.kp, 6);
        copy_float(cmd.kd,               m_tx_joint_command.kd, 6);
    ...
    PackedCommandView ArmCore::pack_impl(const CartesianPose& cmd)
    {
        ...
        copy_float(cmd.kp,             m_tx_cart_command.kp, 6);
        copy_float(cmd.kd,             m_tx_cart_command.kd, 6);
    ...
    PackedCommandView ArmCore::pack_impl(const CartesianVelocities& cmd)
    {
        ...
        copy_float(cmd.kp,                 m_tx_cart_vel_command.kp, 6);
        copy_float(cmd.kd,                 m_tx_cart_vel_command.kd, 6);
