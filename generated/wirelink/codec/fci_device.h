#ifndef WIRELINK_GENERATED_FCI_DEVICE_H
#define WIRELINK_GENERATED_FCI_DEVICE_H

/* Advanced borrowed codec and explicit value/view conversions. */
#include "fci_device_values.h"
...
typedef struct boot_status_info boot_status_info_t;
...
typedef struct get_boot_status_request get_boot_status_request_t;
typedef struct get_boot_status_response get_boot_status_response_t;
typedef struct start_upgrade_request start_upgrade_request_t;
typedef struct start_upgrade_response start_upgrade_response_t;
typedef struct reboot_request reboot_request_t;
typedef struct reboot_response reboot_response_t;
...
struct get_boot_status_request {
  bool has_operation_id;
  uint32_t operation_id;
};

struct get_boot_status_response {
  bool has_operation_id;
  uint32_t operation_id;
  bool has_status;
  upgrade_status_t status;
  bool has_info;
  boot_status_info_t info;
};

struct start_upgrade_request {
  bool has_operation_id;
  uint32_t operation_id;
  bool has_image_id;
  image_id_t image_id;
...
void image_version_clear(image_version_t *value);
size_t image_version_encoded_size(const image_version_t *value);
wl_codec_status_t image_version_encode(const image_version_t *value, uint8_t *out, size_t out_capacity, size_t *out_length);
wl_codec_status_t image_version_decode(const uint8_t *input, size_t input_length, image_version_t *out);
...
void boot_status_info_clear(boot_status_info_t *value);
size_t boot_status_info_encoded_size(const boot_status_info_t *value);
wl_codec_status_t boot_status_info_encode(const boot_status_info_t *value, uint8_t *out, size_t out_capacity, size_t *out_length);
wl_codec_status_t boot_status_info_decode(const uint8_t *input, size_t input_length, boot_status_info_t *out);
...
void get_boot_status_request_clear(get_boot_status_request_t *value);
size_t get_boot_status_request_encoded_size(const get_boot_status_request_t *value);
wl_codec_status_t get_boot_status_request_encode(const get_boot_status_request_t *value, uint8_t *out, size_t out_capacity, size_t *out_length);
wl_codec_status_t get_boot_status_request_decode(const uint8_t *input, size_t input_length, get_boot_status_request_t *out);
...
void get_boot_status_response_clear(get_boot_status_response_t *value);
size_t get_boot_status_response_encoded_size(const get_boot_status_response_t *value);
wl_codec_status_t get_boot_status_response_encode(const get_boot_status_response_t *value, uint8_t *out, size_t out_capacity, size_t *out_length);
wl_codec_status_t get_boot_status_response_decode(const uint8_t *input, size_t input_length, get_boot_status_response_t *out);
...
void start_upgrade_request_clear(start_upgrade_request_t *value);
size_t start_upgrade_request_encoded_size(const start_upgrade_request_t *value);
wl_codec_status_t start_upgrade_request_encode(const start_upgrade_request_t *value, uint8_t *out, size_t out_capacity, size_t *out_length);
wl_codec_status_t start_upgrade_request_decode(const uint8_t *input, size_t input_length, start_upgrade_request_t *out);
...
void start_upgrade_response_clear(start_upgrade_response_t *value);
size_t start_upgrade_response_encoded_size(const start_upgrade_response_t *value);
wl_codec_status_t start_upgrade_response_encode(const start_upgrade_response_t *value, uint8_t *out, size_t out_capacity, size_t *out_length);
wl_codec_status_t start_upgrade_response_decode(const uint8_t *input, size_t input_length, start_upgrade_response_t *out);
...
void reboot_request_clear(reboot_request_t *value);
size_t reboot_request_encoded_size(const reboot_request_t *value);
wl_codec_status_t reboot_request_encode(const reboot_request_t *value, uint8_t *out, size_t out_capacity, size_t *out_length);
wl_codec_status_t reboot_request_decode(const uint8_t *input, size_t input_length, reboot_request_t *out);
...
void reboot_response_clear(reboot_response_t *value);
size_t reboot_response_encoded_size(const reboot_response_t *value);
wl_codec_status_t reboot_response_encode(const reboot_response_t *value, uint8_t *out, size_t out_capacity, size_t *out_length);
wl_codec_status_t reboot_response_decode(const uint8_t *input, size_t input_length, reboot_response_t *out);
