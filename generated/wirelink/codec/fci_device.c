...
static const wlc_desc_t image_version_desc;
static const wlc_desc_t boot_status_info_desc;
...
static const wlc_desc_t get_boot_status_request_desc;
static const wlc_desc_t get_boot_status_response_desc;
static const wlc_desc_t start_upgrade_request_desc;
static const wlc_desc_t start_upgrade_response_desc;
static const wlc_desc_t reboot_request_desc;
static const wlc_desc_t reboot_response_desc;
...
static const wlc_desc_t set_zero_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t clear_error_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };

static const wlc_desc_t home_request_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };

static const wlc_desc_t home_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };

static const wlc_desc_t clear_faults_request_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };

static const wlc_desc_t clear_faults_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t release_control_lease_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };

static const wlc_desc_t get_motor_feedback_request_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t get_device_info_request_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t set_device_info_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t set_arm_control_mode_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t set_gripper_control_mode_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t motor_register_write_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t motor_store_parameters_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t motor_set_zero_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t set_arm_mode_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };

static const wlc_desc_t get_device_settings_request_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_desc_t emergency_stop_request_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };

static const wlc_desc_t emergency_stop_response_desc = { NULL, 0U, WLC_LOOKUP_LINEAR };
...
static const wlc_field_t image_version_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_U8, 1, 0U, 1U, offsetof(image_version_t, major), offsetof(image_version_t, has_major), 0, 0, sizeof(uint8_t), 0U, 0U, { 8U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_U8, 1, 0U, 1U, offsetof(image_version_t, minor), offsetof(image_version_t, has_minor), 0, 0, sizeof(uint8_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_U16, 1, 0U, 1U, offsetof(image_version_t, revision), offsetof(image_version_t, has_revision), 0, 0, sizeof(uint16_t), 0U, 0U, { 24U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 4U, WLC_OPTIONAL, WLC_U32, 1, 0U, 1U, offsetof(image_version_t, build), offsetof(image_version_t, has_build), 0, 0, sizeof(uint32_t), 0U, 0U, { 32U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
static const wlc_desc_t image_version_desc = { image_version_fields, sizeof(image_version_fields) / sizeof(image_version_fields[0]), WLC_LOOKUP_LINEAR };

static const wlc_field_t boot_status_info_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_U16, 1, 0U, 1U, offsetof(boot_status_info_t, protocol_version), offsetof(boot_status_info_t, has_protocol_version), 0, 0, sizeof(uint16_t), 0U, 0U, { 8U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(boot_status_info_t, boot_state), offsetof(boot_status_info_t, has_boot_state), 0, 0, sizeof(boot_state_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(boot_status_info_t, recovery_reason), offsetof(boot_status_info_t, has_recovery_reason), 0, 0, sizeof(recovery_reason_t), 0U, 0U, { 24U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 4U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(boot_status_info_t, active_slot), offsetof(boot_status_info_t, has_active_slot), 0, 0, sizeof(slot_id_t), 0U, 0U, { 32U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 5U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(boot_status_info_t, confirmed_slot), offsetof(boot_status_info_t, has_confirmed_slot), 0, 0, sizeof(slot_id_t), 0U, 0U, { 40U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 6U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(boot_status_info_t, pending_slot), offsetof(boot_status_info_t, has_pending_slot), 0, 0, sizeof(slot_id_t), 0U, 0U, { 48U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 7U, WLC_OPTIONAL, WLC_U16, 1, 0U, 1U, offsetof(boot_status_info_t, write_align), offsetof(boot_status_info_t, has_write_align), 0, 0, sizeof(uint16_t), 0U, 0U, { 56U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 8U, WLC_OPTIONAL, WLC_U16, 1, 0U, 1U, offsetof(boot_status_info_t, max_chunk_size), offsetof(boot_status_info_t, has_max_chunk_size), 0, 0, sizeof(uint16_t), 0U, 0U, { 64U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 9U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(boot_status_info_t, slot0_address), offsetof(boot_status_info_t, has_slot0_address), 0, 0, sizeof(uint32_t), 0U, 0U, { 77U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 10U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(boot_status_info_t, slot0_size), offsetof(boot_status_info_t, has_slot0_size), 0, 0, sizeof(uint32_t), 0U, 0U, { 85U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 11U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(boot_status_info_t, slot1_address), offsetof(boot_status_info_t, has_slot1_address), 0, 0, sizeof(uint32_t), 0U, 0U, { 93U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 12U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(boot_status_info_t, slot1_size), offsetof(boot_status_info_t, has_slot1_size), 0, 0, sizeof(uint32_t), 0U, 0U, { 101U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 13U, WLC_OPTIONAL, WLC_F64, 1, 1U, 1U, offsetof(boot_status_info_t, bytes_written), offsetof(boot_status_info_t, has_bytes_written), 0, 0, sizeof(uint64_t), 0U, 0U, { 105U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 14U, WLC_OPTIONAL, WLC_F32, 0, 5U, 1U, offsetof(boot_status_info_t, active_transfer_id), offsetof(boot_status_info_t, has_active_transfer_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 117U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
static const wlc_desc_t boot_status_info_desc = { boot_status_info_fields, sizeof(boot_status_info_fields) / sizeof(boot_status_info_fields[0]), WLC_LOOKUP_DENSE };

static const wlc_field_t bulk_begin_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_begin_t, transfer_id), offsetof(bulk_begin_t, has_transfer_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 13U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_F64, 1, 1U, 1U, offsetof(bulk_begin_t, total_length), offsetof(bulk_begin_t, has_total_length), 0, 0, sizeof(uint64_t), 0U, 0U, { 17U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_begin_t, requested_chunk_size), offsetof(bulk_begin_t, has_requested_chunk_size), 0, 0, sizeof(uint32_t), 0U, 0U, { 29U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 4U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_begin_t, object_crc32c), offsetof(bulk_begin_t, has_object_crc32c), 0, 0, sizeof(uint32_t), 0U, 0U, { 37U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
...
static const wlc_field_t bulk_chunk_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_chunk_t, transfer_id), offsetof(bulk_chunk_t, has_transfer_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 13U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_F64, 1, 1U, 1U, offsetof(bulk_chunk_t, offset), offsetof(bulk_chunk_t, has_offset), 0, 0, sizeof(uint64_t), 0U, 0U, { 17U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_BYTES, 1, 2U, 1U, offsetof(bulk_chunk_t, data), offsetof(bulk_chunk_t, has_data), 0, 0, sizeof(wl_codec_bytes_t), 0U, 2031U, { 26U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
...
static const wlc_field_t bulk_end_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_end_t, transfer_id), offsetof(bulk_end_t, has_transfer_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 13U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_F64, 1, 1U, 1U, offsetof(bulk_end_t, total_length), offsetof(bulk_end_t, has_total_length), 0, 0, sizeof(uint64_t), 0U, 0U, { 17U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_end_t, object_crc32c), offsetof(bulk_end_t, has_object_crc32c), 0, 0, sizeof(uint32_t), 0U, 0U, { 29U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
...
static const wlc_field_t bulk_abort_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_abort_t, transfer_id), offsetof(bulk_abort_t, has_transfer_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 13U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_I32, 1, 0U, 1U, offsetof(bulk_abort_t, reason), offsetof(bulk_abort_t, has_reason), 0, 0, sizeof(int32_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
...
static const wlc_field_t bulk_status_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_status_t, transfer_id), offsetof(bulk_status_t, has_transfer_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 13U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(bulk_status_t, phase), offsetof(bulk_status_t, has_phase), 0, 0, sizeof(upgrade_bulk_phase_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(bulk_status_t, code), offsetof(bulk_status_t, has_code), 0, 0, sizeof(upgrade_bulk_status_code_t), 0U, 0U, { 24U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 4U, WLC_OPTIONAL, WLC_F64, 1, 1U, 1U, offsetof(bulk_status_t, next_offset), offsetof(bulk_status_t, has_next_offset), 0, 0, sizeof(uint64_t), 0U, 0U, { 33U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 5U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(bulk_status_t, accepted_chunk_size), offsetof(bulk_status_t, has_accepted_chunk_size), 0, 0, sizeof(uint32_t), 0U, 0U, { 45U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
...
static const wlc_field_t get_boot_status_request_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_U32, 1, 0U, 1U, offsetof(get_boot_status_request_t, operation_id), offsetof(get_boot_status_request_t, has_operation_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 8U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
static const wlc_desc_t get_boot_status_request_desc = { get_boot_status_request_fields, sizeof(get_boot_status_request_fields) / sizeof(get_boot_status_request_fields[0]), WLC_LOOKUP_LINEAR };

static const wlc_field_t get_boot_status_response_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_U32, 1, 0U, 1U, offsetof(get_boot_status_response_t, operation_id), offsetof(get_boot_status_response_t, has_operation_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 8U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(get_boot_status_response_t, status), offsetof(get_boot_status_response_t, has_status), 0, 0, sizeof(upgrade_status_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_MESSAGE, 0, 2U, 1U, offsetof(get_boot_status_response_t, info), offsetof(get_boot_status_response_t, has_info), 0, 0, sizeof(boot_status_info_t), 0U, 0U, { 26U, 0U, 0U }, 0, 0ULL, NULL, &boot_status_info_desc },
};
static const wlc_desc_t get_boot_status_response_desc = { get_boot_status_response_fields, sizeof(get_boot_status_response_fields) / sizeof(get_boot_status_response_fields[0]), WLC_LOOKUP_LINEAR };

static const wlc_field_t start_upgrade_request_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_U32, 1, 0U, 1U, offsetof(start_upgrade_request_t, operation_id), offsetof(start_upgrade_request_t, has_operation_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 8U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(start_upgrade_request_t, image_id), offsetof(start_upgrade_request_t, has_image_id), 0, 0, sizeof(image_id_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(start_upgrade_request_t, target_slot), offsetof(start_upgrade_request_t, has_target_slot), 0, 0, sizeof(slot_id_t), 0U, 0U, { 24U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 4U, WLC_OPTIONAL, WLC_U8, 1, 0U, 1U, offsetof(start_upgrade_request_t, flags), offsetof(start_upgrade_request_t, has_flags), 0, 0, sizeof(uint8_t), 0U, 0U, { 32U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 5U, WLC_OPTIONAL, WLC_MESSAGE, 1, 2U, 1U, offsetof(start_upgrade_request_t, image_version), offsetof(start_upgrade_request_t, has_image_version), 0, 0, sizeof(image_version_t), 0U, 0U, { 42U, 0U, 0U }, 0, 0ULL, NULL, &image_version_desc },
  { 6U, WLC_OPTIONAL, WLC_F64, 1, 1U, 1U, offsetof(start_upgrade_request_t, image_size), offsetof(start_upgrade_request_t, has_image_size), 0, 0, sizeof(uint64_t), 0U, 0U, { 49U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 7U, WLC_OPTIONAL, WLC_F32, 1, 5U, 1U, offsetof(start_upgrade_request_t, image_crc32c), offsetof(start_upgrade_request_t, has_image_crc32c), 0, 0, sizeof(uint32_t), 0U, 0U, { 61U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
static const wlc_desc_t start_upgrade_request_desc = { start_upgrade_request_fields, sizeof(start_upgrade_request_fields) / sizeof(start_upgrade_request_fields[0]), WLC_LOOKUP_LINEAR };

static const wlc_field_t start_upgrade_response_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_U32, 1, 0U, 1U, offsetof(start_upgrade_response_t, operation_id), offsetof(start_upgrade_response_t, has_operation_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 8U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(start_upgrade_response_t, status), offsetof(start_upgrade_response_t, has_status), 0, 0, sizeof(upgrade_status_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_F32, 0, 5U, 1U, offsetof(start_upgrade_response_t, transfer_id), offsetof(start_upgrade_response_t, has_transfer_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 29U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 4U, WLC_OPTIONAL, WLC_F64, 0, 1U, 1U, offsetof(start_upgrade_response_t, next_offset), offsetof(start_upgrade_response_t, has_next_offset), 0, 0, sizeof(uint64_t), 0U, 0U, { 33U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 5U, WLC_OPTIONAL, WLC_U16, 0, 0U, 1U, offsetof(start_upgrade_response_t, write_align), offsetof(start_upgrade_response_t, has_write_align), 0, 0, sizeof(uint16_t), 0U, 0U, { 40U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 6U, WLC_OPTIONAL, WLC_U16, 0, 0U, 1U, offsetof(start_upgrade_response_t, max_chunk_size), offsetof(start_upgrade_response_t, has_max_chunk_size), 0, 0, sizeof(uint16_t), 0U, 0U, { 48U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
static const wlc_desc_t start_upgrade_response_desc = { start_upgrade_response_fields, sizeof(start_upgrade_response_fields) / sizeof(start_upgrade_response_fields[0]), WLC_LOOKUP_LINEAR };

static const wlc_field_t reboot_request_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_U32, 1, 0U, 1U, offsetof(reboot_request_t, operation_id), offsetof(reboot_request_t, has_operation_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 8U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(reboot_request_t, mode), offsetof(reboot_request_t, has_mode), 0, 0, sizeof(reboot_mode_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
static const wlc_desc_t reboot_request_desc = { reboot_request_fields, sizeof(reboot_request_fields) / sizeof(reboot_request_fields[0]), WLC_LOOKUP_LINEAR };

static const wlc_field_t reboot_response_fields[] = {
  { 1U, WLC_OPTIONAL, WLC_U32, 1, 0U, 1U, offsetof(reboot_response_t, operation_id), offsetof(reboot_response_t, has_operation_id), 0, 0, sizeof(uint32_t), 0U, 0U, { 8U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 2U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(reboot_response_t, status), offsetof(reboot_response_t, has_status), 0, 0, sizeof(upgrade_status_t), 0U, 0U, { 16U, 0U, 0U }, 0, 0ULL, NULL, NULL },
  { 3U, WLC_OPTIONAL, WLC_ENUM, 1, 0U, 1U, offsetof(reboot_response_t, mode), offsetof(reboot_response_t, has_mode), 0, 0, sizeof(reboot_mode_t), 0U, 0U, { 24U, 0U, 0U }, 0, 0ULL, NULL, NULL },
};
static const wlc_desc_t reboot_response_desc = { reboot_response_fields, sizeof(reboot_response_fields) / sizeof(reboot_response_fields[0]), WLC_LOOKUP_LINEAR };
...
void image_version_clear(image_version_t *value) { if (value != NULL) wlc_clear(&image_version_desc, value); }
size_t image_version_encoded_size(const image_version_t *value) { size_t size; return wlc_measure(&image_version_desc, value, &size) == WL_CODEC_OK ? size : SIZE_MAX; }
wl_codec_status_t image_version_encode(const image_version_t *value, uint8_t *out, size_t cap, size_t *length) { return wlc_encode(&image_version_desc, value, out, cap, length); }
wl_codec_status_t image_version_decode(const uint8_t *input, size_t length, image_version_t *out) { return wlc_decode(&image_version_desc, input, length, out); }

/* Generator-private: value must be the unmodified result of successful decode.
 * hash supplies the caller domain seed; codec has no RPC identity policy. */
wl_codec_status_t image_version_wlc_detail_fingerprint(const image_version_t *value, uint64_t *hash, size_t *length) {
  wlc_hash_state_t state = {*hash, 0U, WL_CODEC_OK};
  wl_codec_status_t status = wlc_hash_emit_fields(&image_version_desc, value, &state);
  if (status != WL_CODEC_OK) return status;
  if (state.status != WL_CODEC_OK) return state.status;
  *hash = state.hash;
  *length = state.length;
...
void boot_status_info_clear(boot_status_info_t *value) { if (value != NULL) wlc_clear(&boot_status_info_desc, value); }
size_t boot_status_info_encoded_size(const boot_status_info_t *value) { size_t size; return wlc_measure(&boot_status_info_desc, value, &size) == WL_CODEC_OK ? size : SIZE_MAX; }
wl_codec_status_t boot_status_info_encode(const boot_status_info_t *value, uint8_t *out, size_t cap, size_t *length) { return wlc_encode(&boot_status_info_desc, value, out, cap, length); }
wl_codec_status_t boot_status_info_decode(const uint8_t *input, size_t length, boot_status_info_t *out) { return wlc_decode(&boot_status_info_desc, input, length, out); }

/* Generator-private: value must be the unmodified result of successful decode.
 * hash supplies the caller domain seed; codec has no RPC identity policy. */
wl_codec_status_t boot_status_info_wlc_detail_fingerprint(const boot_status_info_t *value, uint64_t *hash, size_t *length) {
  wlc_hash_state_t state = {*hash, 0U, WL_CODEC_OK};
  wl_codec_status_t status = wlc_hash_emit_fields(&boot_status_info_desc, value, &state);
  if (status != WL_CODEC_OK) return status;
  if (state.status != WL_CODEC_OK) return state.status;
  *hash = state.hash;
  *length = state.length;
...
void get_boot_status_request_clear(get_boot_status_request_t *value) { if (value != NULL) wlc_clear(&get_boot_status_request_desc, value); }
size_t get_boot_status_request_encoded_size(const get_boot_status_request_t *value) { size_t size; return wlc_measure(&get_boot_status_request_desc, value, &size) == WL_CODEC_OK ? size : SIZE_MAX; }
wl_codec_status_t get_boot_status_request_encode(const get_boot_status_request_t *value, uint8_t *out, size_t cap, size_t *length) { return wlc_encode(&get_boot_status_request_desc, value, out, cap, length); }
wl_codec_status_t get_boot_status_request_decode(const uint8_t *input, size_t length, get_boot_status_request_t *out) { return wlc_decode(&get_boot_status_request_desc, input, length, out); }

/* Generator-private: value must be the unmodified result of successful decode.
 * hash supplies the caller domain seed; codec has no RPC identity policy. */
wl_codec_status_t get_boot_status_request_wlc_detail_fingerprint(const get_boot_status_request_t *value, uint64_t *hash, size_t *length) {
  wlc_hash_state_t state = {*hash, 0U, WL_CODEC_OK};
  wl_codec_status_t status = wlc_hash_emit_fields(&get_boot_status_request_desc, value, &state);
  if (status != WL_CODEC_OK) return status;
  if (state.status != WL_CODEC_OK) return state.status;
  *hash = state.hash;
  *length = state.length;
...
void get_boot_status_response_clear(get_boot_status_response_t *value) { if (value != NULL) wlc_clear(&get_boot_status_response_desc, value); }
size_t get_boot_status_response_encoded_size(const get_boot_status_response_t *value) { size_t size; return wlc_measure(&get_boot_status_response_desc, value, &size) == WL_CODEC_OK ? size : SIZE_MAX; }
wl_codec_status_t get_boot_status_response_encode(const get_boot_status_response_t *value, uint8_t *out, size_t cap, size_t *length) { return wlc_encode(&get_boot_status_response_desc, value, out, cap, length); }
wl_codec_status_t get_boot_status_response_decode(const uint8_t *input, size_t length, get_boot_status_response_t *out) { return wlc_decode(&get_boot_status_response_desc, input, length, out); }

/* Generator-private: value must be the unmodified result of successful decode.
 * hash supplies the caller domain seed; codec has no RPC identity policy. */
wl_codec_status_t get_boot_status_response_wlc_detail_fingerprint(const get_boot_status_response_t *value, uint64_t *hash, size_t *length) {
  wlc_hash_state_t state = {*hash, 0U, WL_CODEC_OK};
  wl_codec_status_t status = wlc_hash_emit_fields(&get_boot_status_response_desc, value, &state);
  if (status != WL_CODEC_OK) return status;
  if (state.status != WL_CODEC_OK) return state.status;
  *hash = state.hash;
  *length = state.length;
...
void start_upgrade_request_clear(start_upgrade_request_t *value) { if (value != NULL) wlc_clear(&start_upgrade_request_desc, value); }
size_t start_upgrade_request_encoded_size(const start_upgrade_request_t *value) { size_t size; return wlc_measure(&start_upgrade_request_desc, value, &size) == WL_CODEC_OK ? size : SIZE_MAX; }
wl_codec_status_t start_upgrade_request_encode(const start_upgrade_request_t *value, uint8_t *out, size_t cap, size_t *length) { return wlc_encode(&start_upgrade_request_desc, value, out, cap, length); }
wl_codec_status_t start_upgrade_request_decode(const uint8_t *input, size_t length, start_upgrade_request_t *out) { return wlc_decode(&start_upgrade_request_desc, input, length, out); }

/* Generator-private: value must be the unmodified result of successful decode.
 * hash supplies the caller domain seed; codec has no RPC identity policy. */
wl_codec_status_t start_upgrade_request_wlc_detail_fingerprint(const start_upgrade_request_t *value, uint64_t *hash, size_t *length) {
  wlc_hash_state_t state = {*hash, 0U, WL_CODEC_OK};
  wl_codec_status_t status = wlc_hash_emit_fields(&start_upgrade_request_desc, value, &state);
  if (status != WL_CODEC_OK) return status;
  if (state.status != WL_CODEC_OK) return state.status;
  *hash = state.hash;
  *length = state.length;
...
void start_upgrade_response_clear(start_upgrade_response_t *value) { if (value != NULL) wlc_clear(&start_upgrade_response_desc, value); }
size_t start_upgrade_response_encoded_size(const start_upgrade_response_t *value) { size_t size; return wlc_measure(&start_upgrade_response_desc, value, &size) == WL_CODEC_OK ? size : SIZE_MAX; }
wl_codec_status_t start_upgrade_response_encode(const start_upgrade_response_t *value, uint8_t *out, size_t cap, size_t *length) { return wlc_encode(&start_upgrade_response_desc, value, out, cap, length); }
wl_codec_status_t start_upgrade_response_decode(const uint8_t *input, size_t length, start_upgrade_response_t *out) { return wlc_decode(&start_upgrade_response_desc, input, length, out); }

/* Generator-private: value must be the unmodified result of successful decode.
 * hash supplies the caller domain seed; codec has no RPC identity policy. */
wl_codec_status_t start_upgrade_response_wlc_detail_fingerprint(const start_upgrade_response_t *value, uint64_t *hash, size_t *length) {
  wlc_hash_state_t state = {*hash, 0U, WL_CODEC_OK};
  wl_codec_status_t status = wlc_hash_emit_fields(&start_upgrade_response_desc, value, &state);
  if (status != WL_CODEC_OK) return status;
  if (state.status != WL_CODEC_OK) return state.status;
  *hash = state.hash;
  *length = state.length;
...
void reboot_request_clear(reboot_request_t *value) { if (value != NULL) wlc_clear(&reboot_request_desc, value); }
size_t reboot_request_encoded_size(const reboot_request_t *value) { size_t size; return wlc_measure(&reboot_request_desc, value, &size) == WL_CODEC_OK ? size : SIZE_MAX; }
wl_codec_status_t reboot_request_encode(const reboot_request_t *value, uint8_t *out, size_t cap, size_t *length) { return wlc_encode(&reboot_request_desc, value, out, cap, length); }
wl_codec_status_t reboot_request_decode(const uint8_t *input, size_t length, reboot_request_t *out) { return wlc_decode(&reboot_request_desc, input, length, out); }

/* Generator-private: value must be the unmodified result of successful decode.
 * hash supplies the caller domain seed; codec has no RPC identity policy. */
wl_codec_status_t reboot_request_wlc_detail_fingerprint(const reboot_request_t *value, uint64_t *hash, size_t *length) {
  wlc_hash_state_t state = {*hash, 0U, WL_CODEC_OK};
  wl_codec_status_t status = wlc_hash_emit_fields(&reboot_request_desc, value, &state);
  if (status != WL_CODEC_OK) return status;
  if (state.status != WL_CODEC_OK) return state.status;
  *hash = state.hash;
  *length = state.length;
...
void reboot_response_clear(reboot_response_t *value) { if (value != NULL) wlc_clear(&reboot_response_desc, value); }
size_t reboot_response_encoded_size(const reboot_response_t *value) { size_t size; return wlc_measure(&reboot_response_desc, value, &size) == WL_CODEC_OK ? size : SIZE_MAX; }
wl_codec_status_t reboot_response_encode(const reboot_response_t *value, uint8_t *out, size_t cap, size_t *length) { return wlc_encode(&reboot_response_desc, value, out, cap, length); }
wl_codec_status_t reboot_response_decode(const uint8_t *input, size_t length, reboot_response_t *out) { return wlc_decode(&reboot_response_desc, input, length, out); }

/* Generator-private: value must be the unmodified result of successful decode.
 * hash supplies the caller domain seed; codec has no RPC identity policy. */
wl_codec_status_t reboot_response_wlc_detail_fingerprint(const reboot_response_t *value, uint64_t *hash, size_t *length) {
  wlc_hash_state_t state = {*hash, 0U, WL_CODEC_OK};
  wl_codec_status_t status = wlc_hash_emit_fields(&reboot_response_desc, value, &state);
  if (status != WL_CODEC_OK) return status;
  if (state.status != WL_CODEC_OK) return state.status;
  *hash = state.hash;
  *length = state.length;
...
static void image_version_value_defaults(image_version_value_t *out) {
  (void)out;
  out->major = 0;
  out->minor = 0;
  out->revision = 0;
  out->build = UINT32_C(0);
}

static void image_version_value_copy_fields(const image_version_t *view, image_version_value_t *out) {
  out->has_major = view->has_major;
  out->major = view->has_major ? view->major : 0;
  out->has_minor = view->has_minor;
  out->minor = view->has_minor ? view->minor : 0;
  out->has_revision = view->has_revision;
  out->revision = view->has_revision ? view->revision : 0;
  out->has_build = view->has_build;
  out->build = view->has_build ? view->build : UINT32_C(0);
}

/* Generator-private: input is an unmodified successful decode, or has been measured. */
void image_version_wlc_detail_value_copy(const image_version_t *view, image_version_value_t *out) {
  memset(out, 0, sizeof(*out));
  image_version_value_copy_fields(view, out);
}

void image_version_value_clear(image_version_value_t *value) {
  if (value == NULL) return;
  memset(value, 0, sizeof(*value));
  image_version_value_defaults(value);
}

wl_codec_status_t image_version_value_from_view(const image_version_t *view, image_version_value_t *out) {
  size_t size;
  wl_codec_status_t status;
  if (view == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = wlc_measure(&image_version_desc, view, &size);
  if (status != WL_CODEC_OK) return status;
  image_version_wlc_detail_value_copy(view, out);
  return WL_CODEC_OK;
}

/* Private conversion does not re-validate each nested subtree. */
static wl_codec_status_t image_version_value_borrow(const image_version_value_t *value, image_version_t *out) {
  image_version_clear(out);
  out->has_major = value->has_major;
  if (value->has_major) {
    out->major = value->major;
  }
  ...
  out->has_revision = value->has_revision;
  if (value->has_revision) {
    out->revision = value->revision;
  }
  out->has_build = value->has_build;
  if (value->has_build) {
    out->build = value->build;
  }
  return WL_CODEC_OK;
}

wl_codec_status_t image_version_value_to_view(const image_version_value_t *value, image_version_t *out) {
  image_version_t view;
  size_t size;
  wl_codec_status_t status;
  if (value == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = image_version_value_borrow(value, &view);
  if (status == WL_CODEC_OK) status = wlc_measure(&image_version_desc, &view, &size);
  if (status != WL_CODEC_OK) return status;
  *out = view;
  return WL_CODEC_OK;
}

size_t image_version_value_encoded_size(const image_version_value_t *value) {
  image_version_t view;
  if (value == NULL || image_version_value_borrow(value, &view) != WL_CODEC_OK) return SIZE_MAX;
  return image_version_encoded_size(&view);
}

wl_codec_status_t image_version_value_encode(const image_version_value_t *value, uint8_t *out, size_t capacity, size_t *length) {
  image_version_t view;
  wl_codec_status_t status;
  if (value == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = image_version_value_borrow(value, &view);
  return status == WL_CODEC_OK ? image_version_encode(&view, out, capacity, length) : status;
}

wl_codec_status_t image_version_value_decode(const uint8_t *input, size_t length, image_version_value_t *out) {
  image_version_t view;
  wl_codec_status_t status;
  if (out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = image_version_decode(input, length, &view);
  if (status != WL_CODEC_OK) return status;
  image_version_wlc_detail_value_copy(&view, out);
  return WL_CODEC_OK;
}

static void boot_status_info_value_defaults(boot_status_info_value_t *out) {
  (void)out;
  out->protocol_version = 0;
  out->boot_state = 0;
  out->recovery_reason = 0;
  out->active_slot = 0;
  out->confirmed_slot = 0;
  out->pending_slot = 0;
  out->write_align = 0;
  out->max_chunk_size = 0;
  out->slot0_address = UINT32_C(0);
  out->slot0_size = UINT32_C(0);
  out->slot1_address = UINT32_C(0);
  out->slot1_size = UINT32_C(0);
  out->bytes_written = UINT64_C(0);
  out->active_transfer_id = UINT32_C(0);
}

static void boot_status_info_value_copy_fields(const boot_status_info_t *view, boot_status_info_value_t *out) {
  out->has_protocol_version = view->has_protocol_version;
  out->protocol_version = view->has_protocol_version ? view->protocol_version : 0;
  out->has_boot_state = view->has_boot_state;
  out->boot_state = view->has_boot_state ? view->boot_state : 0;
  out->has_recovery_reason = view->has_recovery_reason;
  out->recovery_reason = view->has_recovery_reason ? view->recovery_reason : 0;
  out->has_active_slot = view->has_active_slot;
  out->active_slot = view->has_active_slot ? view->active_slot : 0;
  out->has_confirmed_slot = view->has_confirmed_slot;
  out->confirmed_slot = view->has_confirmed_slot ? view->confirmed_slot : 0;
  out->has_pending_slot = view->has_pending_slot;
  out->pending_slot = view->has_pending_slot ? view->pending_slot : 0;
  out->has_write_align = view->has_write_align;
  out->write_align = view->has_write_align ? view->write_align : 0;
  out->has_max_chunk_size = view->has_max_chunk_size;
  out->max_chunk_size = view->has_max_chunk_size ? view->max_chunk_size : 0;
  out->has_slot0_address = view->has_slot0_address;
  out->slot0_address = view->has_slot0_address ? view->slot0_address : UINT32_C(0);
  out->has_slot0_size = view->has_slot0_size;
  out->slot0_size = view->has_slot0_size ? view->slot0_size : UINT32_C(0);
  out->has_slot1_address = view->has_slot1_address;
  out->slot1_address = view->has_slot1_address ? view->slot1_address : UINT32_C(0);
  out->has_slot1_size = view->has_slot1_size;
  out->slot1_size = view->has_slot1_size ? view->slot1_size : UINT32_C(0);
  out->has_bytes_written = view->has_bytes_written;
  out->bytes_written = view->has_bytes_written ? view->bytes_written : UINT64_C(0);
  out->has_active_transfer_id = view->has_active_transfer_id;
  out->active_transfer_id = view->has_active_transfer_id ? view->active_transfer_id : UINT32_C(0);
}

/* Generator-private: input is an unmodified successful decode, or has been measured. */
void boot_status_info_wlc_detail_value_copy(const boot_status_info_t *view, boot_status_info_value_t *out) {
  memset(out, 0, sizeof(*out));
  boot_status_info_value_copy_fields(view, out);
}

void boot_status_info_value_clear(boot_status_info_value_t *value) {
  if (value == NULL) return;
  memset(value, 0, sizeof(*value));
  boot_status_info_value_defaults(value);
}

wl_codec_status_t boot_status_info_value_from_view(const boot_status_info_t *view, boot_status_info_value_t *out) {
  size_t size;
  wl_codec_status_t status;
  if (view == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = wlc_measure(&boot_status_info_desc, view, &size);
  if (status != WL_CODEC_OK) return status;
  boot_status_info_wlc_detail_value_copy(view, out);
  return WL_CODEC_OK;
}

/* Private conversion does not re-validate each nested subtree. */
static wl_codec_status_t boot_status_info_value_borrow(const boot_status_info_value_t *value, boot_status_info_t *out) {
  boot_status_info_clear(out);
  out->has_protocol_version = value->has_protocol_version;
  if (value->has_protocol_version) {
    out->protocol_version = value->protocol_version;
  }
  out->has_boot_state = value->has_boot_state;
  if (value->has_boot_state) {
    out->boot_state = value->boot_state;
  }
  out->has_recovery_reason = value->has_recovery_reason;
  if (value->has_recovery_reason) {
    out->recovery_reason = value->recovery_reason;
  }
  out->has_active_slot = value->has_active_slot;
  if (value->has_active_slot) {
    out->active_slot = value->active_slot;
  }
  out->has_confirmed_slot = value->has_confirmed_slot;
  if (value->has_confirmed_slot) {
    out->confirmed_slot = value->confirmed_slot;
  }
  out->has_pending_slot = value->has_pending_slot;
  if (value->has_pending_slot) {
    out->pending_slot = value->pending_slot;
  }
  out->has_write_align = value->has_write_align;
  if (value->has_write_align) {
    out->write_align = value->write_align;
  }
  out->has_max_chunk_size = value->has_max_chunk_size;
  if (value->has_max_chunk_size) {
    out->max_chunk_size = value->max_chunk_size;
  }
  out->has_slot0_address = value->has_slot0_address;
  if (value->has_slot0_address) {
    out->slot0_address = value->slot0_address;
  }
  out->has_slot0_size = value->has_slot0_size;
  if (value->has_slot0_size) {
    out->slot0_size = value->slot0_size;
  }
  out->has_slot1_address = value->has_slot1_address;
  if (value->has_slot1_address) {
    out->slot1_address = value->slot1_address;
  }
  out->has_slot1_size = value->has_slot1_size;
  if (value->has_slot1_size) {
    out->slot1_size = value->slot1_size;
  }
  out->has_bytes_written = value->has_bytes_written;
  if (value->has_bytes_written) {
    out->bytes_written = value->bytes_written;
  }
  out->has_active_transfer_id = value->has_active_transfer_id;
  if (value->has_active_transfer_id) {
    out->active_transfer_id = value->active_transfer_id;
  }
  return WL_CODEC_OK;
}

wl_codec_status_t boot_status_info_value_to_view(const boot_status_info_value_t *value, boot_status_info_t *out) {
  boot_status_info_t view;
  size_t size;
  wl_codec_status_t status;
  if (value == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = boot_status_info_value_borrow(value, &view);
  if (status == WL_CODEC_OK) status = wlc_measure(&boot_status_info_desc, &view, &size);
  if (status != WL_CODEC_OK) return status;
  *out = view;
  return WL_CODEC_OK;
}

size_t boot_status_info_value_encoded_size(const boot_status_info_value_t *value) {
  boot_status_info_t view;
  if (value == NULL || boot_status_info_value_borrow(value, &view) != WL_CODEC_OK) return SIZE_MAX;
  return boot_status_info_encoded_size(&view);
}

wl_codec_status_t boot_status_info_value_encode(const boot_status_info_value_t *value, uint8_t *out, size_t capacity, size_t *length) {
  boot_status_info_t view;
  wl_codec_status_t status;
  if (value == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = boot_status_info_value_borrow(value, &view);
  return status == WL_CODEC_OK ? boot_status_info_encode(&view, out, capacity, length) : status;
}

wl_codec_status_t boot_status_info_value_decode(const uint8_t *input, size_t length, boot_status_info_value_t *out) {
  boot_status_info_t view;
  wl_codec_status_t status;
  if (out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = boot_status_info_decode(input, length, &view);
  if (status != WL_CODEC_OK) return status;
  boot_status_info_wlc_detail_value_copy(&view, out);
  return WL_CODEC_OK;
}
...
static wl_codec_status_t bulk_chunk_value_borrow(const bulk_chunk_value_t *value, bulk_chunk_t *out) {
  ...
  if (value->has_data) {
    if (value->data.length > 2031U) return WL_CODEC_ERR_INVALID_VALUE;
...
static void get_boot_status_request_value_defaults(get_boot_status_request_value_t *out) {
  (void)out;
  out->operation_id = UINT32_C(0);
}

static void get_boot_status_request_value_copy_fields(const get_boot_status_request_t *view, get_boot_status_request_value_t *out) {
  out->has_operation_id = view->has_operation_id;
  out->operation_id = view->has_operation_id ? view->operation_id : UINT32_C(0);
}

/* Generator-private: input is an unmodified successful decode, or has been measured. */
void get_boot_status_request_wlc_detail_value_copy(const get_boot_status_request_t *view, get_boot_status_request_value_t *out) {
  memset(out, 0, sizeof(*out));
  get_boot_status_request_value_copy_fields(view, out);
}

void get_boot_status_request_value_clear(get_boot_status_request_value_t *value) {
  if (value == NULL) return;
  memset(value, 0, sizeof(*value));
  get_boot_status_request_value_defaults(value);
}

wl_codec_status_t get_boot_status_request_value_from_view(const get_boot_status_request_t *view, get_boot_status_request_value_t *out) {
  size_t size;
  wl_codec_status_t status;
  if (view == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = wlc_measure(&get_boot_status_request_desc, view, &size);
  if (status != WL_CODEC_OK) return status;
  get_boot_status_request_wlc_detail_value_copy(view, out);
  return WL_CODEC_OK;
}

/* Private conversion does not re-validate each nested subtree. */
static wl_codec_status_t get_boot_status_request_value_borrow(const get_boot_status_request_value_t *value, get_boot_status_request_t *out) {
  get_boot_status_request_clear(out);
...
wl_codec_status_t get_boot_status_request_value_to_view(const get_boot_status_request_value_t *value, get_boot_status_request_t *out) {
  get_boot_status_request_t view;
  size_t size;
  wl_codec_status_t status;
  if (value == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = get_boot_status_request_value_borrow(value, &view);
  if (status == WL_CODEC_OK) status = wlc_measure(&get_boot_status_request_desc, &view, &size);
  if (status != WL_CODEC_OK) return status;
  *out = view;
  return WL_CODEC_OK;
}

size_t get_boot_status_request_value_encoded_size(const get_boot_status_request_value_t *value) {
  get_boot_status_request_t view;
  if (value == NULL || get_boot_status_request_value_borrow(value, &view) != WL_CODEC_OK) return SIZE_MAX;
  return get_boot_status_request_encoded_size(&view);
}

wl_codec_status_t get_boot_status_request_value_encode(const get_boot_status_request_value_t *value, uint8_t *out, size_t capacity, size_t *length) {
  get_boot_status_request_t view;
  wl_codec_status_t status;
  if (value == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = get_boot_status_request_value_borrow(value, &view);
  return status == WL_CODEC_OK ? get_boot_status_request_encode(&view, out, capacity, length) : status;
}

wl_codec_status_t get_boot_status_request_value_decode(const uint8_t *input, size_t length, get_boot_status_request_value_t *out) {
  get_boot_status_request_t view;
  wl_codec_status_t status;
  if (out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = get_boot_status_request_decode(input, length, &view);
  if (status != WL_CODEC_OK) return status;
  get_boot_status_request_wlc_detail_value_copy(&view, out);
  return WL_CODEC_OK;
}

static void get_boot_status_response_value_defaults(get_boot_status_response_value_t *out) {
  (void)out;
  out->operation_id = UINT32_C(0);
  out->status = 0;
  boot_status_info_value_defaults(&out->info);
}

static void get_boot_status_response_value_copy_fields(const get_boot_status_response_t *view, get_boot_status_response_value_t *out) {
  out->has_operation_id = view->has_operation_id;
  out->operation_id = view->has_operation_id ? view->operation_id : UINT32_C(0);
  out->has_status = view->has_status;
  out->status = view->has_status ? view->status : 0;
  out->has_info = view->has_info;
  if (view->has_info) boot_status_info_value_copy_fields(&view->info, &out->info);
  else boot_status_info_value_defaults(&out->info);
}

/* Generator-private: input is an unmodified successful decode, or has been measured. */
void get_boot_status_response_wlc_detail_value_copy(const get_boot_status_response_t *view, get_boot_status_response_value_t *out) {
  memset(out, 0, sizeof(*out));
  get_boot_status_response_value_copy_fields(view, out);
}

void get_boot_status_response_value_clear(get_boot_status_response_value_t *value) {
  if (value == NULL) return;
  memset(value, 0, sizeof(*value));
  get_boot_status_response_value_defaults(value);
}

wl_codec_status_t get_boot_status_response_value_from_view(const get_boot_status_response_t *view, get_boot_status_response_value_t *out) {
  size_t size;
  wl_codec_status_t status;
  if (view == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = wlc_measure(&get_boot_status_response_desc, view, &size);
  if (status != WL_CODEC_OK) return status;
  get_boot_status_response_wlc_detail_value_copy(view, out);
  return WL_CODEC_OK;
}

/* Private conversion does not re-validate each nested subtree. */
static wl_codec_status_t get_boot_status_response_value_borrow(const get_boot_status_response_value_t *value, get_boot_status_response_t *out) {
  get_boot_status_response_clear(out);
  out->has_operation_id = value->has_operation_id;
  if (value->has_operation_id) {
    out->operation_id = value->operation_id;
  }
  ...
  out->has_info = value->has_info;
  if (value->has_info) {
    wl_codec_status_t status = boot_status_info_value_borrow(&value->info, &out->info);
    if (status != WL_CODEC_OK) return status;
  }
  return WL_CODEC_OK;
}

wl_codec_status_t get_boot_status_response_value_to_view(const get_boot_status_response_value_t *value, get_boot_status_response_t *out) {
  get_boot_status_response_t view;
  size_t size;
  wl_codec_status_t status;
  if (value == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = get_boot_status_response_value_borrow(value, &view);
  if (status == WL_CODEC_OK) status = wlc_measure(&get_boot_status_response_desc, &view, &size);
  if (status != WL_CODEC_OK) return status;
  *out = view;
  return WL_CODEC_OK;
}

size_t get_boot_status_response_value_encoded_size(const get_boot_status_response_value_t *value) {
  get_boot_status_response_t view;
  if (value == NULL || get_boot_status_response_value_borrow(value, &view) != WL_CODEC_OK) return SIZE_MAX;
  return get_boot_status_response_encoded_size(&view);
}

wl_codec_status_t get_boot_status_response_value_encode(const get_boot_status_response_value_t *value, uint8_t *out, size_t capacity, size_t *length) {
  get_boot_status_response_t view;
  wl_codec_status_t status;
  if (value == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = get_boot_status_response_value_borrow(value, &view);
  return status == WL_CODEC_OK ? get_boot_status_response_encode(&view, out, capacity, length) : status;
}

wl_codec_status_t get_boot_status_response_value_decode(const uint8_t *input, size_t length, get_boot_status_response_value_t *out) {
  get_boot_status_response_t view;
  wl_codec_status_t status;
  if (out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = get_boot_status_response_decode(input, length, &view);
  if (status != WL_CODEC_OK) return status;
  get_boot_status_response_wlc_detail_value_copy(&view, out);
  return WL_CODEC_OK;
}

static void start_upgrade_request_value_defaults(start_upgrade_request_value_t *out) {
  (void)out;
  out->operation_id = UINT32_C(0);
  out->image_id = 0;
  out->target_slot = 0;
  out->flags = 0;
  image_version_value_defaults(&out->image_version);
  out->image_size = UINT64_C(0);
  out->image_crc32c = UINT32_C(0);
}

static void start_upgrade_request_value_copy_fields(const start_upgrade_request_t *view, start_upgrade_request_value_t *out) {
  out->has_operation_id = view->has_operation_id;
  out->operation_id = view->has_operation_id ? view->operation_id : UINT32_C(0);
  out->has_image_id = view->has_image_id;
  out->image_id = view->has_image_id ? view->image_id : 0;
  out->has_target_slot = view->has_target_slot;
  out->target_slot = view->has_target_slot ? view->target_slot : 0;
  out->has_flags = view->has_flags;
  out->flags = view->has_flags ? view->flags : 0;
  out->has_image_version = view->has_image_version;
  if (view->has_image_version) image_version_value_copy_fields(&view->image_version, &out->image_version);
  else image_version_value_defaults(&out->image_version);
  out->has_image_size = view->has_image_size;
  out->image_size = view->has_image_size ? view->image_size : UINT64_C(0);
  out->has_image_crc32c = view->has_image_crc32c;
  out->image_crc32c = view->has_image_crc32c ? view->image_crc32c : UINT32_C(0);
}

/* Generator-private: input is an unmodified successful decode, or has been measured. */
void start_upgrade_request_wlc_detail_value_copy(const start_upgrade_request_t *view, start_upgrade_request_value_t *out) {
  memset(out, 0, sizeof(*out));
  start_upgrade_request_value_copy_fields(view, out);
}

void start_upgrade_request_value_clear(start_upgrade_request_value_t *value) {
  if (value == NULL) return;
  memset(value, 0, sizeof(*value));
  start_upgrade_request_value_defaults(value);
}

wl_codec_status_t start_upgrade_request_value_from_view(const start_upgrade_request_t *view, start_upgrade_request_value_t *out) {
  size_t size;
  wl_codec_status_t status;
  if (view == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = wlc_measure(&start_upgrade_request_desc, view, &size);
  if (status != WL_CODEC_OK) return status;
  start_upgrade_request_wlc_detail_value_copy(view, out);
  return WL_CODEC_OK;
}

/* Private conversion does not re-validate each nested subtree. */
static wl_codec_status_t start_upgrade_request_value_borrow(const start_upgrade_request_value_t *value, start_upgrade_request_t *out) {
  start_upgrade_request_clear(out);
  out->has_operation_id = value->has_operation_id;
  if (value->has_operation_id) {
    out->operation_id = value->operation_id;
  }
  out->has_image_id = value->has_image_id;
  if (value->has_image_id) {
    out->image_id = value->image_id;
  }
  out->has_target_slot = value->has_target_slot;
  if (value->has_target_slot) {
    out->target_slot = value->target_slot;
  }
  out->has_flags = value->has_flags;
  if (value->has_flags) {
    out->flags = value->flags;
  }
  out->has_image_version = value->has_image_version;
  if (value->has_image_version) {
    wl_codec_status_t status = image_version_value_borrow(&value->image_version, &out->image_version);
    if (status != WL_CODEC_OK) return status;
  }
  out->has_image_size = value->has_image_size;
  if (value->has_image_size) {
    out->image_size = value->image_size;
  }
  out->has_image_crc32c = value->has_image_crc32c;
  if (value->has_image_crc32c) {
    out->image_crc32c = value->image_crc32c;
  }
  return WL_CODEC_OK;
}

wl_codec_status_t start_upgrade_request_value_to_view(const start_upgrade_request_value_t *value, start_upgrade_request_t *out) {
  start_upgrade_request_t view;
  size_t size;
  wl_codec_status_t status;
  if (value == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = start_upgrade_request_value_borrow(value, &view);
  if (status == WL_CODEC_OK) status = wlc_measure(&start_upgrade_request_desc, &view, &size);
  if (status != WL_CODEC_OK) return status;
  *out = view;
  return WL_CODEC_OK;
}

size_t start_upgrade_request_value_encoded_size(const start_upgrade_request_value_t *value) {
  start_upgrade_request_t view;
  if (value == NULL || start_upgrade_request_value_borrow(value, &view) != WL_CODEC_OK) return SIZE_MAX;
  return start_upgrade_request_encoded_size(&view);
}

wl_codec_status_t start_upgrade_request_value_encode(const start_upgrade_request_value_t *value, uint8_t *out, size_t capacity, size_t *length) {
  start_upgrade_request_t view;
  wl_codec_status_t status;
  if (value == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = start_upgrade_request_value_borrow(value, &view);
  return status == WL_CODEC_OK ? start_upgrade_request_encode(&view, out, capacity, length) : status;
}

wl_codec_status_t start_upgrade_request_value_decode(const uint8_t *input, size_t length, start_upgrade_request_value_t *out) {
  start_upgrade_request_t view;
  wl_codec_status_t status;
  if (out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = start_upgrade_request_decode(input, length, &view);
  if (status != WL_CODEC_OK) return status;
  start_upgrade_request_wlc_detail_value_copy(&view, out);
  return WL_CODEC_OK;
}

static void start_upgrade_response_value_defaults(start_upgrade_response_value_t *out) {
  (void)out;
  out->operation_id = UINT32_C(0);
  out->status = 0;
  out->transfer_id = UINT32_C(0);
...
static void start_upgrade_response_value_copy_fields(const start_upgrade_response_t *view, start_upgrade_response_value_t *out) {
  out->has_operation_id = view->has_operation_id;
  out->operation_id = view->has_operation_id ? view->operation_id : UINT32_C(0);
  out->has_status = view->has_status;
  out->status = view->has_status ? view->status : 0;
...
/* Generator-private: input is an unmodified successful decode, or has been measured. */
void start_upgrade_response_wlc_detail_value_copy(const start_upgrade_response_t *view, start_upgrade_response_value_t *out) {
  memset(out, 0, sizeof(*out));
  start_upgrade_response_value_copy_fields(view, out);
}

void start_upgrade_response_value_clear(start_upgrade_response_value_t *value) {
  if (value == NULL) return;
  memset(value, 0, sizeof(*value));
  start_upgrade_response_value_defaults(value);
}

wl_codec_status_t start_upgrade_response_value_from_view(const start_upgrade_response_t *view, start_upgrade_response_value_t *out) {
  size_t size;
  wl_codec_status_t status;
  if (view == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = wlc_measure(&start_upgrade_response_desc, view, &size);
  if (status != WL_CODEC_OK) return status;
  start_upgrade_response_wlc_detail_value_copy(view, out);
  return WL_CODEC_OK;
}

/* Private conversion does not re-validate each nested subtree. */
static wl_codec_status_t start_upgrade_response_value_borrow(const start_upgrade_response_value_t *value, start_upgrade_response_t *out) {
  start_upgrade_response_clear(out);
  out->has_operation_id = value->has_operation_id;
  if (value->has_operation_id) {
    out->operation_id = value->operation_id;
  }
...
wl_codec_status_t start_upgrade_response_value_to_view(const start_upgrade_response_value_t *value, start_upgrade_response_t *out) {
  start_upgrade_response_t view;
  size_t size;
  wl_codec_status_t status;
  if (value == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = start_upgrade_response_value_borrow(value, &view);
  if (status == WL_CODEC_OK) status = wlc_measure(&start_upgrade_response_desc, &view, &size);
  if (status != WL_CODEC_OK) return status;
  *out = view;
  return WL_CODEC_OK;
}

size_t start_upgrade_response_value_encoded_size(const start_upgrade_response_value_t *value) {
  start_upgrade_response_t view;
  if (value == NULL || start_upgrade_response_value_borrow(value, &view) != WL_CODEC_OK) return SIZE_MAX;
  return start_upgrade_response_encoded_size(&view);
}

wl_codec_status_t start_upgrade_response_value_encode(const start_upgrade_response_value_t *value, uint8_t *out, size_t capacity, size_t *length) {
  start_upgrade_response_t view;
  wl_codec_status_t status;
  if (value == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = start_upgrade_response_value_borrow(value, &view);
  return status == WL_CODEC_OK ? start_upgrade_response_encode(&view, out, capacity, length) : status;
}

wl_codec_status_t start_upgrade_response_value_decode(const uint8_t *input, size_t length, start_upgrade_response_value_t *out) {
  start_upgrade_response_t view;
  wl_codec_status_t status;
  if (out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = start_upgrade_response_decode(input, length, &view);
  if (status != WL_CODEC_OK) return status;
  start_upgrade_response_wlc_detail_value_copy(&view, out);
  return WL_CODEC_OK;
}

static void reboot_request_value_defaults(reboot_request_value_t *out) {
  (void)out;
  out->operation_id = UINT32_C(0);
  out->mode = 0;
}

static void reboot_request_value_copy_fields(const reboot_request_t *view, reboot_request_value_t *out) {
  out->has_operation_id = view->has_operation_id;
  out->operation_id = view->has_operation_id ? view->operation_id : UINT32_C(0);
  out->has_mode = view->has_mode;
  out->mode = view->has_mode ? view->mode : 0;
...
/* Generator-private: input is an unmodified successful decode, or has been measured. */
void reboot_request_wlc_detail_value_copy(const reboot_request_t *view, reboot_request_value_t *out) {
  memset(out, 0, sizeof(*out));
  reboot_request_value_copy_fields(view, out);
}

void reboot_request_value_clear(reboot_request_value_t *value) {
  if (value == NULL) return;
  memset(value, 0, sizeof(*value));
  reboot_request_value_defaults(value);
}

wl_codec_status_t reboot_request_value_from_view(const reboot_request_t *view, reboot_request_value_t *out) {
  size_t size;
  wl_codec_status_t status;
  if (view == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = wlc_measure(&reboot_request_desc, view, &size);
  if (status != WL_CODEC_OK) return status;
  reboot_request_wlc_detail_value_copy(view, out);
  return WL_CODEC_OK;
}

/* Private conversion does not re-validate each nested subtree. */
static wl_codec_status_t reboot_request_value_borrow(const reboot_request_value_t *value, reboot_request_t *out) {
  reboot_request_clear(out);
  out->has_operation_id = value->has_operation_id;
  if (value->has_operation_id) {
    out->operation_id = value->operation_id;
  }
...
wl_codec_status_t reboot_request_value_to_view(const reboot_request_value_t *value, reboot_request_t *out) {
  reboot_request_t view;
  size_t size;
  wl_codec_status_t status;
  if (value == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = reboot_request_value_borrow(value, &view);
  if (status == WL_CODEC_OK) status = wlc_measure(&reboot_request_desc, &view, &size);
  if (status != WL_CODEC_OK) return status;
  *out = view;
  return WL_CODEC_OK;
}

size_t reboot_request_value_encoded_size(const reboot_request_value_t *value) {
  reboot_request_t view;
  if (value == NULL || reboot_request_value_borrow(value, &view) != WL_CODEC_OK) return SIZE_MAX;
  return reboot_request_encoded_size(&view);
}

wl_codec_status_t reboot_request_value_encode(const reboot_request_value_t *value, uint8_t *out, size_t capacity, size_t *length) {
  reboot_request_t view;
  wl_codec_status_t status;
  if (value == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = reboot_request_value_borrow(value, &view);
  return status == WL_CODEC_OK ? reboot_request_encode(&view, out, capacity, length) : status;
}

wl_codec_status_t reboot_request_value_decode(const uint8_t *input, size_t length, reboot_request_value_t *out) {
  reboot_request_t view;
  wl_codec_status_t status;
  if (out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = reboot_request_decode(input, length, &view);
  if (status != WL_CODEC_OK) return status;
  reboot_request_wlc_detail_value_copy(&view, out);
  return WL_CODEC_OK;
}

static void reboot_response_value_defaults(reboot_response_value_t *out) {
  (void)out;
  out->operation_id = UINT32_C(0);
  out->status = 0;
  out->mode = 0;
...
static void reboot_response_value_copy_fields(const reboot_response_t *view, reboot_response_value_t *out) {
  out->has_operation_id = view->has_operation_id;
  out->operation_id = view->has_operation_id ? view->operation_id : UINT32_C(0);
  out->has_status = view->has_status;
  out->status = view->has_status ? view->status : 0;
...
/* Generator-private: input is an unmodified successful decode, or has been measured. */
void reboot_response_wlc_detail_value_copy(const reboot_response_t *view, reboot_response_value_t *out) {
  memset(out, 0, sizeof(*out));
  reboot_response_value_copy_fields(view, out);
}

void reboot_response_value_clear(reboot_response_value_t *value) {
  if (value == NULL) return;
  memset(value, 0, sizeof(*value));
  reboot_response_value_defaults(value);
}

wl_codec_status_t reboot_response_value_from_view(const reboot_response_t *view, reboot_response_value_t *out) {
  size_t size;
  wl_codec_status_t status;
  if (view == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = wlc_measure(&reboot_response_desc, view, &size);
  if (status != WL_CODEC_OK) return status;
  reboot_response_wlc_detail_value_copy(view, out);
  return WL_CODEC_OK;
}

/* Private conversion does not re-validate each nested subtree. */
static wl_codec_status_t reboot_response_value_borrow(const reboot_response_value_t *value, reboot_response_t *out) {
  reboot_response_clear(out);
  out->has_operation_id = value->has_operation_id;
  if (value->has_operation_id) {
    out->operation_id = value->operation_id;
  }
...
wl_codec_status_t reboot_response_value_to_view(const reboot_response_value_t *value, reboot_response_t *out) {
  reboot_response_t view;
  size_t size;
  wl_codec_status_t status;
  if (value == NULL || out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = reboot_response_value_borrow(value, &view);
  if (status == WL_CODEC_OK) status = wlc_measure(&reboot_response_desc, &view, &size);
  if (status != WL_CODEC_OK) return status;
  *out = view;
  return WL_CODEC_OK;
}

size_t reboot_response_value_encoded_size(const reboot_response_value_t *value) {
  reboot_response_t view;
  if (value == NULL || reboot_response_value_borrow(value, &view) != WL_CODEC_OK) return SIZE_MAX;
  return reboot_response_encoded_size(&view);
}

wl_codec_status_t reboot_response_value_encode(const reboot_response_value_t *value, uint8_t *out, size_t capacity, size_t *length) {
  reboot_response_t view;
  wl_codec_status_t status;
  if (value == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = reboot_response_value_borrow(value, &view);
  return status == WL_CODEC_OK ? reboot_response_encode(&view, out, capacity, length) : status;
}

wl_codec_status_t reboot_response_value_decode(const uint8_t *input, size_t length, reboot_response_value_t *out) {
  reboot_response_t view;
  wl_codec_status_t status;
  if (out == NULL) return WL_CODEC_ERR_INVALID_VALUE;
  status = reboot_response_decode(input, length, &view);
  if (status != WL_CODEC_OK) return status;
  reboot_response_wlc_detail_value_copy(&view, out);
  return WL_CODEC_OK;
}
