#ifndef WIRELINK_GENERATED_FCI_DEVICE_H_VALUES
#define WIRELINK_GENERATED_FCI_DEVICE_H_VALUES
...
typedef int32_t upgrade_status_t;
#define UPGRADE_OK INT32_C(0)
#define UPGRADE_BUSY INT32_C(1)
#define UPGRADE_INVALID_STATE INT32_C(2)
#define UPGRADE_INVALID_ARGUMENT INT32_C(3)
#define UPGRADE_OUT_OF_RANGE INT32_C(4)
#define UPGRADE_CRC_MISMATCH INT32_C(5)
#define UPGRADE_FLASH_FAILURE INT32_C(6)
#define UPGRADE_VERIFY_FAILURE INT32_C(7)
#define UPGRADE_SIGNATURE_FAILURE INT32_C(8)
#define UPGRADE_UNSUPPORTED INT32_C(9)
#define UPGRADE_INTERNAL_ERROR INT32_C(10)

typedef int32_t image_id_t;
#define IMAGE_APPLICATION INT32_C(0)

typedef int32_t slot_id_t;
#define SLOT_NONE INT32_C(0)
#define SLOT_PRIMARY INT32_C(1)
#define SLOT_SECONDARY INT32_C(2)

typedef int32_t boot_state_t;
#define BOOT_IDLE INT32_C(0)
#define BOOT_RECOVERY INT32_C(1)
#define BOOT_UPGRADING INT32_C(2)
#define BOOT_PENDING_TEST INT32_C(3)
#define BOOT_BOOTING INT32_C(4)

typedef int32_t recovery_reason_t;
#define RECOVERY_NONE INT32_C(0)
#define RECOVERY_KEY_PRESSED INT32_C(1)
#define RECOVERY_NO_BOOTABLE_IMAGE INT32_C(2)
#define RECOVERY_IMAGE_VALIDATION_FAILED INT32_C(3)
#define RECOVERY_UPGRADE_REQUESTED INT32_C(4)
#define RECOVERY_INTERNAL_FAILURE INT32_C(5)

typedef int32_t reboot_mode_t;
#define REBOOT_NORMAL INT32_C(0)
#define REBOOT_STAY_IN_RECOVERY INT32_C(1)
#define REBOOT_TRY_BOOT_IMMEDIATELY INT32_C(2)

typedef int32_t upgrade_bulk_phase_t;
#define UPGRADE_BULK_PHASE_NONE INT32_C(0)
#define UPGRADE_BULK_PHASE_BEGIN INT32_C(1)
#define UPGRADE_BULK_PHASE_CHUNK INT32_C(2)
#define UPGRADE_BULK_PHASE_END INT32_C(3)
#define UPGRADE_BULK_PHASE_ABORT INT32_C(4)

typedef int32_t upgrade_bulk_status_code_t;
#define UPGRADE_BULK_STATUS_OK INT32_C(0)
#define UPGRADE_BULK_STATUS_BUSY INT32_C(1)
#define UPGRADE_BULK_STATUS_OUT_OF_ORDER INT32_C(2)
#define UPGRADE_BULK_STATUS_CONFLICT INT32_C(3)
#define UPGRADE_BULK_STATUS_INVALID INT32_C(4)
#define UPGRADE_BULK_STATUS_WRITE_FAILED INT32_C(5)
#define UPGRADE_BULK_STATUS_INTEGRITY_FAILED INT32_C(6)
#define UPGRADE_BULK_STATUS_ABORTED INT32_C(7)
#define UPGRADE_BULK_STATUS_TIMED_OUT INT32_C(8)
...
#define IMAGE_VERSION_HAS_VALUE 1
typedef struct {
  bool has_major;
  uint8_t major;
  bool has_minor;
  ...
  bool has_build;
  uint32_t build;
} image_version_value_t;
#define IMAGE_VERSION_VALUE_SIZE (sizeof(image_version_value_t))
...
#define BOOT_STATUS_INFO_HAS_VALUE 1
typedef struct {
  bool has_protocol_version;
  uint16_t protocol_version;
  bool has_boot_state;
  boot_state_t boot_state;
  bool has_recovery_reason;
  recovery_reason_t recovery_reason;
  bool has_active_slot;
  slot_id_t active_slot;
  bool has_confirmed_slot;
  slot_id_t confirmed_slot;
  bool has_pending_slot;
  slot_id_t pending_slot;
  bool has_write_align;
  uint16_t write_align;
  bool has_max_chunk_size;
  uint16_t max_chunk_size;
  bool has_slot0_address;
  uint32_t slot0_address;
  bool has_slot0_size;
  uint32_t slot0_size;
  bool has_slot1_address;
  uint32_t slot1_address;
  bool has_slot1_size;
  uint32_t slot1_size;
  bool has_bytes_written;
  uint64_t bytes_written;
  bool has_active_transfer_id;
  uint32_t active_transfer_id;
} boot_status_info_value_t;
#define BOOT_STATUS_INFO_VALUE_SIZE (sizeof(boot_status_info_value_t))
...
typedef struct {
  ...
  uint64_t offset;
  bool has_data;
  struct { size_t length; uint8_t data[2031]; } data;
} bulk_chunk_value_t;
...
typedef struct {
  ...
  uint32_t transfer_id;
  bool has_phase;
  upgrade_bulk_phase_t phase;
  bool has_code;
  upgrade_bulk_status_code_t code;
...
#define GET_BOOT_STATUS_REQUEST_HAS_VALUE 1
typedef struct {
  bool has_operation_id;
  uint32_t operation_id;
} get_boot_status_request_value_t;
#define GET_BOOT_STATUS_REQUEST_VALUE_SIZE (sizeof(get_boot_status_request_value_t))
...
#define GET_BOOT_STATUS_RESPONSE_HAS_VALUE 1
typedef struct {
  bool has_operation_id;
  uint32_t operation_id;
  bool has_status;
  ...
  bool has_info;
  boot_status_info_value_t info;
} get_boot_status_response_value_t;
#define GET_BOOT_STATUS_RESPONSE_VALUE_SIZE (sizeof(get_boot_status_response_value_t))
...
#define START_UPGRADE_REQUEST_HAS_VALUE 1
typedef struct {
  bool has_operation_id;
  uint32_t operation_id;
  bool has_image_id;
  image_id_t image_id;
  bool has_target_slot;
  slot_id_t target_slot;
  bool has_flags;
  uint8_t flags;
  bool has_image_version;
  image_version_value_t image_version;
  bool has_image_size;
  uint64_t image_size;
  bool has_image_crc32c;
  uint32_t image_crc32c;
} start_upgrade_request_value_t;
#define START_UPGRADE_REQUEST_VALUE_SIZE (sizeof(start_upgrade_request_value_t))
...
#define START_UPGRADE_RESPONSE_HAS_VALUE 1
typedef struct {
  bool has_operation_id;
  uint32_t operation_id;
  bool has_status;
  ...
  bool has_max_chunk_size;
  uint16_t max_chunk_size;
} start_upgrade_response_value_t;
#define START_UPGRADE_RESPONSE_VALUE_SIZE (sizeof(start_upgrade_response_value_t))
...
#define REBOOT_REQUEST_HAS_VALUE 1
typedef struct {
  bool has_operation_id;
  uint32_t operation_id;
  bool has_mode;
  reboot_mode_t mode;
} reboot_request_value_t;
#define REBOOT_REQUEST_VALUE_SIZE (sizeof(reboot_request_value_t))
...
#define REBOOT_RESPONSE_HAS_VALUE 1
typedef struct {
  bool has_operation_id;
  uint32_t operation_id;
  bool has_status;
  ...
  bool has_mode;
  reboot_mode_t mode;
} reboot_response_value_t;
#define REBOOT_RESPONSE_VALUE_SIZE (sizeof(reboot_response_value_t))
...
#define IMAGE_VERSION_MESSAGE_ID 28689U
#define IMAGE_VERSION_HAS_MAX_ENCODED_SIZE 1
#define IMAGE_VERSION_MAX_ENCODED_SIZE UINT64_C(16)
#define BOOT_STATUS_INFO_MESSAGE_ID 28690U
#define BOOT_STATUS_INFO_HAS_MAX_ENCODED_SIZE 1
#define BOOT_STATUS_INFO_MAX_ENCODED_SIZE UINT64_C(76)
#define BULK_BEGIN_MESSAGE_ID 28704U
#define BULK_BEGIN_HAS_MAX_ENCODED_SIZE 1
#define BULK_BEGIN_MAX_ENCODED_SIZE UINT64_C(24)
#define BULK_CHUNK_MESSAGE_ID 28705U
#define BULK_CHUNK_HAS_MAX_ENCODED_SIZE 1
#define BULK_CHUNK_MAX_ENCODED_SIZE UINT64_C(2048)
#define BULK_END_MESSAGE_ID 28706U
#define BULK_END_HAS_MAX_ENCODED_SIZE 1
#define BULK_END_MAX_ENCODED_SIZE UINT64_C(19)
#define BULK_ABORT_MESSAGE_ID 28707U
#define BULK_ABORT_HAS_MAX_ENCODED_SIZE 1
#define BULK_ABORT_MAX_ENCODED_SIZE UINT64_C(11)
#define BULK_STATUS_MESSAGE_ID 28708U
#define BULK_STATUS_HAS_MAX_ENCODED_SIZE 1
#define BULK_STATUS_MAX_ENCODED_SIZE UINT64_C(31)
#define GET_BOOT_STATUS_REQUEST_MESSAGE_ID 28928U
#define GET_BOOT_STATUS_REQUEST_HAS_MAX_ENCODED_SIZE 1
#define GET_BOOT_STATUS_REQUEST_MAX_ENCODED_SIZE UINT64_C(6)
#define GET_BOOT_STATUS_RESPONSE_MESSAGE_ID 28929U
#define GET_BOOT_STATUS_RESPONSE_HAS_MAX_ENCODED_SIZE 1
#define GET_BOOT_STATUS_RESPONSE_MAX_ENCODED_SIZE UINT64_C(90)
#define START_UPGRADE_REQUEST_MESSAGE_ID 28930U
#define START_UPGRADE_REQUEST_HAS_MAX_ENCODED_SIZE 1
#define START_UPGRADE_REQUEST_MAX_ENCODED_SIZE UINT64_C(53)
#define START_UPGRADE_RESPONSE_MESSAGE_ID 28931U
#define START_UPGRADE_RESPONSE_HAS_MAX_ENCODED_SIZE 1
#define START_UPGRADE_RESPONSE_MAX_ENCODED_SIZE UINT64_C(34)
#define REBOOT_REQUEST_MESSAGE_ID 28932U
#define REBOOT_REQUEST_HAS_MAX_ENCODED_SIZE 1
#define REBOOT_REQUEST_MAX_ENCODED_SIZE UINT64_C(12)
#define REBOOT_RESPONSE_MESSAGE_ID 28933U
#define REBOOT_RESPONSE_HAS_MAX_ENCODED_SIZE 1
#define REBOOT_RESPONSE_MAX_ENCODED_SIZE UINT64_C(18)
#ifdef __cplusplus
}
#endif
